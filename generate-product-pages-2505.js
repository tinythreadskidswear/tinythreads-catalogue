...
<style>
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .prod-img{width:100%;max-height:320px;object-fit:contain;border-radius:12px;
            background:#FFF8F5;margin-bottom:1.2rem;}
...
<div class="card">
  ...
  ${primaryImg ? `<img class="prod-img"
       src="https://res.cloudinary.com/tinythreads/image/upload/c_pad,w_800,h_800,b_rgb:FFF8F5,g_north,q_auto,f_auto/${primaryImg.split('/upload/').pop()}"
